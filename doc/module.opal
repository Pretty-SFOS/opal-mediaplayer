...
briefDescription: QML module for adding media player views to Sailfish apps

# description of this module: may use rich text and will be translated in
# Opal Gallery. Line breaks can included with '\n' but should be avoided.
description: This module provides a media player page with support for subtitles.
...
authors: Mirian Margiani:Leszek Lesner:Simo Piiroinen:Muki
...
extraGalleryPages: ViewVideoPage.qml
